...
const CategorySlider = () => {
  ...
  //   ================ create scroll button end =========================//

  //   ================ scroll button show start =========================//
      ...
      >
        {categories.map((cat) => {
          ...
          return (
            <motion.div
              key={cat.id}
              className={`min-w-37.5 flex flex-col items-center justify-center rounded-2xl ${cat.color} shadow-md hover:shadow-xl transition-all coursor:pointer `}
            >
              <div className="flex flex-col items-center justify-center p-5">
                <Icon className="w-10 h-10 text-green-700 mb-3" />
                <p className="text-center text-sm md:text-base font-semibold text-green-700">
                  {cat.name}
                </p>
              </div>
            </motion.div>
